...
cleaningModalTitle: "Integrated cleaning solutions for healthy, organized, and presentable environments",
cleaningModalIntro: "Smart Touch delivers integrated cleaning services aimed at maintaining facility cleanliness, improving hygienic and visual standards, and ensuring safe, organized environments through trained teams, approved materials, and operating plans tailored to each site.",

cleaningSectionATitle: "(A) Post-Construction and Periodic Cleaning",
cleaningSectionAIntro: "Our cleaning scope in this category covers post-construction cleaning, deep cleaning, and periodic operational services for different facility types and surfaces.",
cleaningSectionA1: "Removal of cement stains, oil marks, paint residues, and accumulated dust resulting from construction or renovation works.",
cleaningSectionA2: "Cleaning and polishing of glass, marble, and metal surfaces using safe and approved materials.",
cleaningSectionA3: "Washing and cleaning all types of flooring, including ceramic, marble, granite, and parquet, according to the nature of each surface.",
cleaningSectionA4: "Cleaning and sanitizing bathrooms and pantry areas in line with high health and safety standards.",
cleaningSectionA5: "Cleaning doors, windows, partitions, and curtains of all types.",
cleaningSectionA6: "Cleaning garages, entrances, and outdoor areas related to the facility.",
cleaningSectionA7: "Cleaning elevators, lighting units, and external AC surfaces.",
cleaningSectionA8: "Cleaning and polishing wooden, leather, and metal furniture.",
cleaningSectionA9: "Carpet and rug cleaning using specialized equipment to remove dust and stains effectively while preserving fabric quality.",

cleaningPeriodicTitle: "Periodic Cleaning",
cleaningPeriodic1: "Daily Cleaning: Floors, surfaces, furniture, bathrooms, and offices are cleaned regularly, with routine waste collection and disposal.",
cleaningPeriodic2: "Weekly Cleaning: Full-site general cleaning, floor polishing, glass and façade cleaning, and special attention to hard-to-reach areas.",
cleaningPeriodic3: "Monthly Cleaning: Deep cleaning services covering all major items, with preventive pest-control treatment when required.",

cleaningSectionBTitle: "(B) Internal and Residential Cleaning",
cleaningSectionBSubtitle: "The Touch of Perfection",
cleaningSectionBText: "At Smart Touch, we believe that cleaning a home or office is not just a routine task, but an essential part of comfort, health, and quality of life. That is why we offer The Touch of Perfection, a comprehensive internal and residential cleaning package designed to care for fine details and deliver a higher level of cleanliness and comfort across homes, offices, and interior spaces.",
...
cleaningModalTitle: "حلول نظافة متكاملة لبيئات صحية ومنظمة واحترافية",
cleaningModalIntro: "تقدم سمارت تاتش خدمات نظافة متكاملة تهدف إلى الحفاظ على نظافة المنشآت، ورفع المستوى الصحي والجمالي للموقع، وضمان بيئة آمنة ومنظمة من خلال فرق مدربة، ومواد معتمدة، وخطط تشغيل مناسبة لطبيعة كل موقع.",

cleaningSectionATitle: "(أ) أعمال النظافة التأسيسية والنظافة الدورية",
cleaningSectionAIntro: "يشمل نطاق هذه الخدمة أعمال النظافة التأسيسية، والتنظيف العميق، وبرامج النظافة التشغيلية الدورية لمختلف أنواع المنشآت والأسطح.",
cleaningSectionA1: "إزالة البقع الأسمنتية والزيتية وبقايا الدهانات والأتربة المتراكمة الناتجة عن أعمال البناء أو التجديد.",
cleaningSectionA2: "تنظيف وتلميع الأسطح الزجاجية والرخامية والمعدنية باستخدام مواد آمنة ومعتمدة.",
cleaningSectionA3: "غسل وتنظيف جميع أنواع الأرضيات مثل السيراميك والرخام والجرانيت والباركيه بما يتناسب مع طبيعة كل سطح.",
cleaningSectionA4: "تنظيف وتعقيم الحمامات والبوفيهات وفق أعلى معايير الصحة والسلامة.",
cleaningSectionA5: "تنظيف الأبواب والشبابيك والقواطع والستائر بجميع أنواعها.",
cleaningSectionA6: "تنظيف الجراجات والمداخل والمناطق الخارجية التابعة للمنشأة.",
cleaningSectionA7: "تنظيف المصاعد ووحدات الإضاءة وأجهزة التكييف من الخارج.",
cleaningSectionA8: "تنظيف وتلميع الأثاث الخشبي والجلدي والمعدني.",
cleaningSectionA9: "تنظيف السجاد والموكيت باستخدام معدات متخصصة لإزالة الأتربة والبقع بفعالية مع الحفاظ على الأنسجة.",

cleaningPeriodicTitle: "النظافة الدورية",
cleaningPeriodic1: "نظافة يومية: تنظيف الأرضيات والأسطح والأثاث والحمامات والمكاتب، مع جمع المخلفات والنفايات بشكل منتظم.",
cleaningPeriodic2: "نظافة أسبوعية: تنفيذ نظافة عامة شاملة للموقع، وتلميع الأرضيات، وتنظيف الزجاج والواجهات، والاهتمام بالمناطق صعبة الوصول.",
cleaningPeriodic3: "نظافة شهرية: أعمال تنظيف عميق تشمل جميع البنود الرئيسية، مع رش وقائي بالمبيدات عند الحاجة.",

cleaningSectionBTitle: "(ب) النظافة الداخلية والسكنية",
cleaningSectionBSubtitle: "لمسة المثالية",
cleaningSectionBText: "في سمارت تاتش، نؤمن أن نظافة المنزل أو المكتب ليست مجرد مهمة يومية، بل هي عنصر أساسي للراحة والصحة وجودة الحياة. لذلك نقدم خدمة لمسة المثالية، وهي باقة نظافة داخلية وسكنية شاملة صُممت للاهتمام بأدق التفاصيل، وتقديم مستوى عالٍ من النظافة والراحة في الوحدات السكنية والمكاتب والفراغات الداخلية المختلفة.",
